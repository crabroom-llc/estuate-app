...
export async function POST(request: Request) {
  try {
    ...
    // ("Insert into user_oauthdeails Values(stripe_access_token,stripe_refresh_token,stripe_user_id,userId)");
    const InsertTokens = await query(
      "INSERT INTO user_oauth (stripe_access_token, stripe_refresh_token, stripe_acc, user_id) VALUES (?, ?, ?, ?)",
      [access_token, refresh_token, stripe_user_id, userId]
    );
    console.log(InsertTokens[0].affectedRows);
