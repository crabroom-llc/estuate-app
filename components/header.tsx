...
const Header = () => {
    ...
    return (
        <header className={`fixed top-0 left-0 w-full bg-white shadow-md z-50 md:px-44`}>
            <div className="container mx-auto flex items-center justify-between py-3 px-6">
                ...
                <div className="flex flex-row items-center space-x-6">
                    <nav className="flex space-x-6">
                        <Link href="/settings"><span className="text-gray-700 hover:text-red-600 cursor-pointer">Settings</span></Link>
                    </nav>
